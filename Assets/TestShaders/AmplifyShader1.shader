...
Shader "AmplifyShader1"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_NoiseScale("NoiseScale", Float) = 50
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult35 = (float2(IN.ase_texcoord7.xyz.y , IN.ase_texcoord7.xyz.z));
				float simplePerlin2D41 = snoise( appendResult35*_NoiseScale );
				simplePerlin2D41 = simplePerlin2D41*0.5 + 0.5;
				float3 temp_output_47_0 = abs( IN.ase_normal );
				float3 break50 = ( temp_output_47_0 * temp_output_47_0 );
				float lerpResult60 = lerp( 0.0 , simplePerlin2D41 , break50.x);
				float2 appendResult34 = (float2(IN.ase_texcoord7.xyz.x , IN.ase_texcoord7.xyz.z));
				float simplePerlin2D40 = snoise( appendResult34*_NoiseScale );
				simplePerlin2D40 = simplePerlin2D40*0.5 + 0.5;
				float lerpResult61 = lerp( 0.0 , simplePerlin2D40 , break50.y);
				float2 appendResult28 = (float2(IN.ase_texcoord7.xyz.x , IN.ase_texcoord7.xyz.y));
				float simplePerlin2D38 = snoise( appendResult28*_NoiseScale );
				simplePerlin2D38 = simplePerlin2D38*0.5 + 0.5;
				float lerpResult62 = lerp( 0.0 , simplePerlin2D38 , break50.z);
				float3 temp_cast_0 = (( ( lerpResult60 + lerpResult61 ) + lerpResult62 )).xxx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult35 = (float2(IN.ase_texcoord2.xyz.y , IN.ase_texcoord2.xyz.z));
				float simplePerlin2D41 = snoise( appendResult35*_NoiseScale );
				simplePerlin2D41 = simplePerlin2D41*0.5 + 0.5;
				float3 temp_output_47_0 = abs( IN.ase_normal );
				float3 break50 = ( temp_output_47_0 * temp_output_47_0 );
				float lerpResult60 = lerp( 0.0 , simplePerlin2D41 , break50.x);
				float2 appendResult34 = (float2(IN.ase_texcoord2.xyz.x , IN.ase_texcoord2.xyz.z));
				float simplePerlin2D40 = snoise( appendResult34*_NoiseScale );
				simplePerlin2D40 = simplePerlin2D40*0.5 + 0.5;
				float lerpResult61 = lerp( 0.0 , simplePerlin2D40 , break50.y);
				float2 appendResult28 = (float2(IN.ase_texcoord2.xyz.x , IN.ase_texcoord2.xyz.y));
				float simplePerlin2D38 = snoise( appendResult28*_NoiseScale );
				simplePerlin2D38 = simplePerlin2D38*0.5 + 0.5;
				float lerpResult62 = lerp( 0.0 , simplePerlin2D38 , break50.z);
				float3 temp_cast_0 = (( ( lerpResult60 + lerpResult61 ) + lerpResult62 )).xxx;
...
/*ASEBEGIN
Version=18935
256;73;1954;1012;3595.363;1850.424;3.047111;True;True
Node;AmplifyShaderEditor.NormalVertexDataNode;46;-1396.956,-1024.974;Inherit;True;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.AbsOpNode;47;-1133.326,-1025.809;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.PosVertexDataNode;8;-2689.359,-375.3546;Inherit;True;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;35;-2300.316,-634.6721;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;34;-2304.131,-380.9674;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-2319.778,-809.0039;Inherit;False;Property;_NoiseScale;NoiseScale;0;0;Create;True;0;0;0;False;0;False;50;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;48;-944.3236,-1022.026;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;41;-1883.196,-761.0722;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;40;-1883.617,-506.7486;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;28;-2301.185,-119.3539;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.BreakToComponentsNode;50;-778.978,-1021.694;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.NoiseGeneratorNode;38;-1881.748,-249.8042;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;60;-499.1889,-765.2325;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;61;-499.0564,-512.5137;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;54;-150.1029,-765.07;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;62;-491.1024,-253.32;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;55;107.201,-632.1356;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;64;257.0671,12.81523;Inherit;False;Property;_Smoothness;Smoothness;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;63;258.0671,-118.1848;Inherit;False;Property;_Metallic;Metallic;1;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;678.2288,-165.5447;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;AmplifyShader1;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
WireConnection;35;0;8;2
WireConnection;35;1;8;3
WireConnection;34;0;8;1
WireConnection;34;1;8;3
...
ASEEND*/
//CHKSM=C6DE19E1230AA6B9F61CBEB395D4C68BE315CADA